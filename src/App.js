...
const initialTasks = [
  ...
  },
  {
    ...
    description: "Audit slow queries and add missing indexes in production DB.",
    due_date: "2026-04-12",
  ...
  },
  {
    ...
    description: "Create content calendar for April and May across platforms.",
    due_date: "2026-04-03",
    assigned_to: "Riya Desai",
    assigned_by: "Arjun Nair",
    status: "Done",
  ...
  },
  {
    ...
    description: "Run Locust load tests and identify performance bottlenecks.",
    due_date: "2026-04-19",
    assigned_to: "Vikram Bose",
    assigned_by: "Keerthi Rajan",
    status: "In Progress",
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="col-1">
          <h3>Create Tasks</h3>
          <SaveTaskForm onFormSubmit={saveTask} />
        </div>
        <div className="col-2">
          <h3>My Tasks</h3>
